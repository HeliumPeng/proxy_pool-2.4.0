...
class ProxyFetcher(object):
    ...
    def JuLiangProxy():
        # 巨量代理
        proxy_url = "http://v2.api.juliangip.com/unlimited/getips?num=10&pt=1&result_type=json&trade_no=5223548325683162&sign=490b95d33283b1350710d47089e1aa57"
        proxies = requests.get(proxy_url).json()['data']['proxy_list']
        for proxy in proxies:
            yield proxy
    
    @staticmethod
    def xunYZProxy():
        url = "http://api.xdaili.cn/xdaili-api//greatRecharge/getGreatIp?spiderId=523acd89241848c4bee8d8c9a194855f&orderno=YZ2022103093948sNzNZ&returnType=2&count=10"
        try:
